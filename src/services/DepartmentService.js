...
export const createDepartment = (department) =>
  axios.post(DEPARTMENT_REST_API_URL, department);

export const getDepartmentById = (departmentId) =>
  axios.get(DEPARTMENT_REST_API_URL + "/" + departmentId);

export const updateDepartment = (departmentId, department) =>
  axios.patch(DEPARTMENT_REST_API_URL + "/" + departmentId, department);

export const deleteDepartment = (departmentId) =>
  axios.delete(DEPARTMENT_REST_API_URL + "/" + departmentId);
